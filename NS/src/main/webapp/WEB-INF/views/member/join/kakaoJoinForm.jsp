    ...
    <div class="container text-start pt-5 pb-5">
      ...
      <form id="joinForm" class="needs-validation" novalidate>
        ...
        <div class="mb-3 row justify-content-center">
          <label for="staticEmail" class="col-2 col-form-label">닉네임*</label>
          <div class="col-6">
        ...
        <div class="mb-3 row justify-content-center">
          <label for="staticEmail" class="col-2 col-form-label">휴대폰 번호*</label>
          <div class="col-2">
        ...
        <div class="mb-3 row justify-content-center">
          <label for="join" class="col-sm-2 col-form-label">이용 약관</label>
        ...
        <div class="row mb-4 mt-4 justify-content-center">
          <div class="col-sm-10">
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" readonly> 제1조(목적) 이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
	 		...
	 		<div class="col-10" style="padding:10px 25px;">
	 			<input class="form-check-input" type="checkbox"  value="" id="agreement1" required/>
	          	<label class="form-check-label" for="agreement" style="font-size:12px">[필수]회원가입 이용 약관 동의</label>
	          </div>
	          </div>
	        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-10 text-end">
            <button type="button" class="btn btn-secondary me-3" name="join">회원 가입</button>
...
$(document).ready(function() {
	...
	function fn_checkMember() {
		var memEmail = '${member.MEM_EMAIL}';
		var memPw = '${member.MEM_PW}';
		var memName = '${member.MEM_NAME}';
		var memNickname = $('#MEM_NICKNAME').val();
		var memBirth = '${member.MEM_BIRTH}';
		var memGen = '${member.MEM_GEN}';
	...
	(() => {
	  ...
	  $("button[name='join']").on("click", function(e) {  // 관리자 공지사항 작성
		e.preventDefault();
